    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navigation-bar">
            <ul class="navbar-nav" style="margin-left: auto;">
                <li class="nav-item"><a class="nav-link" href="#Superlogin" id="navigation">SuperUser</a></li>
                <li class="nav-item"><a class="nav-link" href="#adminlogin" id="navigation"> Admin</a></li>
                <li class="nav-item"><a class="nav-link" href="#Userlogin" id="navigation">User</a></li>
